...
export default function LeaguePage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      if (chain.length > 0) setLeagueName(chain[0].name);
      setSeasons(chain);
  ...
  return (
    <div className="min-h-screen bg-zinc-950 px-4 py-10 font-sans">
      <div className="mx-auto w-full max-w-4xl">
        ...
        <div className="mb-6">
          ...
          <h1 className="mt-2 text-2xl font-bold text-white">{leagueName}</h1>
          <p className="text-sm text-zinc-400">Dynasty history</p>
        </div>
